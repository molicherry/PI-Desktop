...
export const ko = {
  ...
  chat: {
    ...
    timingSent: "보냄 {{time}}",
    timingElapsed: "소요 {{time}}",
    timingCardTitle: "이번 턴 소요 시간",
    timingElapsedLabel: "소요 시간",
    timingFirstTokenLabel: "첫 토큰",
    replyUsageLabel: "사용량",
    replyUsageTitle: "이번 턴 사용량",
    replyUsageProvider: "제공자 / 모델",
    usageUncachedInput: "캐시되지 않은 입력",
    replyUsageReasoningSuffix: " (추론 {{count}})",
    tokenUnit: "tok",
