export const en = {
  ...
  chat: {
    ...
    timingSent: "Sent {{time}}",
    timingElapsed: "Elapsed {{time}}",
    /* The card the elapsed segment opens: its own title, not the usage title. */
    timingCardTitle: "This turn's timing",
    /* Card row labels: the value is formatted by the caller. */
    timingElapsedLabel: "Elapsed",
    timingFirstTokenLabel: "First token",
    replyUsageLabel: "Usage",
    replyUsageTitle: "This turn's usage",
    replyUsageProvider: "Provider / model",
    usageUncachedInput: "Uncached input",
    replyUsageReasoningSuffix: " ({{count}} reasoning)",
    tokenUnit: "tok",
