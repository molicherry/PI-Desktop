...
export const zhTW = {
  ...
  chat: {
    ...
    timingSent: "傳送 {{time}}",
    timingElapsed: "耗時 {{time}}",
    timingCardTitle: "本輪耗時",
    timingElapsedLabel: "耗時",
    timingFirstTokenLabel: "首 token",
    replyUsageLabel: "用量",
    replyUsageTitle: "本輪用量",
    replyUsageProvider: "提供方 / 模型",
    usageUncachedInput: "未快取輸入",
    replyUsageReasoningSuffix: "（其中推理 {{count}}）",
    tokenUnit: "tok",
    durationHours: "{{count}} 時",
