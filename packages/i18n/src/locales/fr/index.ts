...
export const fr = {
  ...
  "chat": {
    ...
    "timingSent": "Envoyé {{time}}",
    "timingElapsed": "Durée {{time}}",
    "timingCardTitle": "Durée de ce tour",
    "timingElapsedLabel": "Durée",
    "timingFirstTokenLabel": "Premier token",
    "replyUsageLabel": "Usage",
    "replyUsageTitle": "Usage de ce tour",
    "replyUsageProvider": "Fournisseur / modèle",
    "usageUncachedInput": "Entrée non mise en cache",
    "replyUsageReasoningSuffix": " ({{count}} de raisonnement)",
    "tokenUnit": "tok",
