...
export const es = {
  ...
  "chat": {
    ...
    "timingSent": "Enviado {{time}}",
    "timingElapsed": "Duración {{time}}",
    "timingCardTitle": "Duración de este turno",
    "timingElapsedLabel": "Duración",
    "timingFirstTokenLabel": "Primer token",
    "replyUsageLabel": "Uso",
    "replyUsageTitle": "Uso de este turno",
    "replyUsageProvider": "Proveedor / modelo",
    "usageUncachedInput": "Entrada sin caché",
    "replyUsageReasoningSuffix": " ({{count}} de razonamiento)",
    "tokenUnit": "tok",
