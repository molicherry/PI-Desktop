...
export const tr = {
  ...
  chat: {
    ...
    timingSent: "Gönderildi {{time}}",
    timingElapsed: "Süre {{time}}",
    timingCardTitle: "Bu turun süresi",
    timingElapsedLabel: "Süre",
    timingFirstTokenLabel: "İlk token",
    replyUsageLabel: "Kullanım",
    replyUsageTitle: "Bu turun kullanımı",
    replyUsageProvider: "Sağlayıcı / model",
    usageUncachedInput: "Önbelleksiz girdi",
    replyUsageReasoningSuffix: " ({{count}} akıl yürütme)",
    tokenUnit: "tok",
