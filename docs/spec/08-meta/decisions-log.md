...
- macOS DMGs expose `PI-Desktop-macOS-opening-help.txt` with the Finder label
  `如果打不开请看.txt` and no longer include or expose the executable
